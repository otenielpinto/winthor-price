// Repository class for produto_preco_new table using SQLite
import { lib } from "../utils/lib.js";
import { sql3Client } from "../config/sql3Client.js";

class ProductPrecoNewRepository {
  constructor() {
    this.db = null;
    this.tableName = "produto_preco_new";
  }
...
export { ProductPrecoNewRepository };
